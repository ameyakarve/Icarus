...
(function(window) {
    ...
    LacesMap.prototype = new LacesObject({$node: LacesMap.$node});
    ...
    function LacesModel(object, options) {
        ...
        this.$node = options.$node||'undefinedDiv';
        LacesMap.call(this, object, options);
    }

    LacesModel.prototype = new LacesMap({}, {$node: LacesModel.$node});
    ...
    LacesModel.prototype.set = function(key, value, options) {
        ...
        if (typeof value === 'function') {
            ...
            for (var i = 0, length = dependencies.length; i < length; i++) {
                ...
                this.bind('change:' + dependency, reevalualate);
            }
    ...
    function LacesArray(options) {
        ...
        Object.defineProperty(array,'$node',{
            'value': this.$node,
            'writable': false
        });
    ...
    LacesArray.prototype = new LacesObject({$node: LacesArray.$node});
